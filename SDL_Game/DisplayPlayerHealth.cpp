...
DisplayPlayerHealth::DisplayPlayerHealth(GameObject* game_object, PlayerStat* player_stat) : Component(game_object), player_stat(player_stat)
{
	src_rect.x = 0;
	src_rect.y = 0;
